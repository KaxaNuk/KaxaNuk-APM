...
## [0.2.1] - 2026-09-05
### Changed
- `python-bloom-code` instructions 2.1.0: every judgment rule ends with a `Verification:` line saying how to
  prove it held (pattern borrowed from battle_tested_skills `python-standards`).
